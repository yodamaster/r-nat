...
void TcpClient::Start(std::string domain, uint16_t port)
{
	Start(domain,std::to_string(port));
}

void TcpClient::Start(std::string domain, std::string port)
{
...
void TcpClient::Start(uint32_t ip, uint16_t port)
{
